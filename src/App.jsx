                   ...
                   {[
                      ...
                      >
                        ...
                        <div className="w-full h-full bg-white dark:bg-[#121826] group-hover:bg-slate-50 dark:group-hover:bg-[#0b0e14] border border-slate-200 dark:border-[#1e293b] rounded-xl p-5 flex items-center gap-4 transition-colors duration-300 relative z-10">
                          <div className="w-12 h-12 rounded-lg bg-blue-100 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/20 flex items-center justify-center text-blue-600 dark:text-blue-500 group-hover:bg-blue-200 dark:group-hover:bg-blue-500/25 group-hover:scale-105 transition-transform flex-shrink-0">
